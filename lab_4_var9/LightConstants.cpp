...
GLfloat LightConstants::lightPosition[] = { 0.0, 0.0, -15.0, 0.0 };
...
GLfloat LightConstants::distantLightDirection[] = { 1.0, 0.0, -1.0, 1.0 };
...
GLfloat LightConstants::pointLightPosition[] = { 2, 2, -8.0, 1.0 };
...
{
	*(LightConstants::spotlightPosition) = value;
}

GLfloat LightConstants::getSpotlightPosition()
{
	return *(LightConstants::spotlightPosition);
}
